-- CORREÇÃO CIRÚRGICA: Corrigir apenas o nome da coluna stage_order

-- Buscar a RPC atual e corrigir apenas a coluna
...
BEGIN
    ...
    -- 🎯 CORREÇÃO: Definir texto da mensagem CORRETAMENTE
    ...
    IF v_lead_id IS NULL THEN
        ...
        -- 🎯 CORREÇÃO CRÍTICA: Buscar primeiro stage usando order_position
        IF v_funnel_id IS NOT NULL THEN
            SELECT id INTO v_first_stage_id
            FROM public.kanban_stages
            WHERE funnel_id = v_funnel_id
            ORDER BY order_position ASC  -- ✅ CORRIGIDO: order_position ao invés de stage_order
            LIMIT 1;
        END IF;
