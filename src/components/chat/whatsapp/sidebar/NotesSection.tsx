  ...
  return (
    <div className="bg-white/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/40">
      ...
      <Textarea
        ...
        className="bg-white/20 backdrop-blur-sm border-white/40 focus:border-lime-400 focus:ring-lime-400/20 min-h-[120px] resize-none text-gray-800 placeholder:text-gray-600"
        onBlur={onSave}
      />
    </div>
  );
