...
import { Phone, Edit3, Check } from 'lucide-react';
        ...
        <div className="overflow-y-auto max-h-[90vh] kanban-horizontal-scroll">
          <div className="px-8 pt-8 pb-6">
            <div className="flex items-center gap-4">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-orange-600 to-red-600 shadow-lg shadow-orange-600/30">
            ...
            <p className="text-sm text-gray-600 mt-2 ml-[60px]">
              Transferir atendimento para um operador humano
            </p>
          </div>
          ...
          <div className="px-8 pb-8 space-y-6">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Ex: Encaminhar para atendente humano quando necessário"
                rows={3}
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-white/40">
              ...
              <button
                onClick={handleSave}
                disabled={!isValid()}
                className="px-6 py-2.5 bg-gradient-to-br from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white rounded-full text-sm font-medium shadow-lg shadow-orange-600/30 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
