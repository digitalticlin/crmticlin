...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl bg-white/80 dark:bg-white/5 backdrop-blur-sm shadow-lg border-0 transition-all duration-200 hover:shadow-xl hover:bg-white/90 dark:hover:bg-white/10",
      className
    )}
    {...props}
  />
