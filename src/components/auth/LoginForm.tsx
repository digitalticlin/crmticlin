    ...
    <div className="w-full rounded-3xl relative overflow-hidden bg-gradient-to-b from-ticlin-400 to-transparent shadow-2xl transition-all duration-500 hover:shadow-3xl hover:scale-[1.02]">
      ...
      <div className="relative z-10 p-8 space-y-8">
          ...
          <div className="mb-6 flex justify-center">
            <div className="relative">
              <img
                ...
                alt="Ticlin CRM"
                className="h-14 transition-transform duration-300 hover:scale-110 brightness-0 invert"
              />
            </div>
          </div>
        ...
        <div className="text-center text-sm text-white/90">
          Não tem uma conta?{" "}
          <Link to="/register" className="text-white font-medium hover:text-white/80 transition-colors duration-200 underline-offset-4 hover:underline">
            Criar conta
          </Link>
        </div>
      </div>
