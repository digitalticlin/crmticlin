...
export default function KPICard({ title, value, trend, icon, className }: KPICardProps) {
  ...
  return (
    <div className={cn(
      "rounded-3xl bg-white/35 backdrop-blur-lg border border-white/30 shadow-2xl p-6 space-y-4 transition-all duration-500 hover:shadow-3xl hover:scale-[1.02] hover:bg-white/40 animate-fade-in",
      className
    )}>
