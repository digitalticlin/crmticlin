    ...
    return (
      <div className="min-h-[500px] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-white/70">Carregando equipe...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 animate-fade-in">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white">Adicionar Membro</h3>
              <p className="text-white/70">Convide novos colaboradores para sua equipe</p>
            </div>
          </div>
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 animate-fade-in" style={{ animationDelay: "100ms" }}>
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white">Visão Geral da Equipe</h3>
            <p className="text-white/70">Estatísticas e informações gerais</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-white/70">Total de Membros</p>
          ...
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-white/70">Administradores</p>
          ...
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-white/70">Funções Ativas</p>
                <p className="text-2xl font-bold text-white">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-white/70">Gerencie permissões e configurações dos membros</p>
          </div>
        </div>
