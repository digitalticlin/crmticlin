    ...
    >
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="sticky top-0 z-30 w-full flex flex-col gap-4 pb-2">
          <div
            className="backdrop-blur-md glass bg-white/80 dark:bg-[#221F26ee] rounded-b-3xl shadow-glass-lg px-6 md:px-10 py-4 md:py-6 flex flex-col md:flex-row justify-between items-center border-b border-slate-200/15 dark:border-white/10 transition-all"
          >
            ...
            <div className="mt-6 md:mt-0 flex gap-2">
              {activeTab === "won-lost" ? (
                <Button
                  variant="outline"
                  className="rounded-full bg-white/80 dark:bg-[#333333cc] border-none shadow glass text-neutral-800 dark:text-white font-inter font-medium text-base h-11 px-6 hover:ring-2 hover:ring-ticlin"
          ...
          <div className="flex w-full justify-center">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-auto">
              <TabsList className="shadow glass bg-white/75 dark:bg-[#232323cc] border-none flex px-2 gap-2 rounded-full py-1">
                <TabsTrigger
                  value="funnel"
