...
// Conteúdo corrigido para o webhook auto_whatsapp_sync
const correctedWebhook = `import { serve } from "https://deno.land/std@0.168.0/http/server.ts";
...
console.log('📋 Salvando webhook corrigido...');

fs.writeFileSync('corrected_auto_whatsapp_sync_index.ts', correctedWebhook);
console.log('✅ Arquivo corrected_auto_whatsapp_sync_index.ts criado');
console.log('');
console.log('🚀 PRÓXIMOS PASSOS:');
console.log('1. Copie o arquivo corrected_auto_whatsapp_sync_index.ts para a VPS');
console.log('2. Substitua o conteúdo de /root/supabase/functions/auto_whatsapp_sync/index.ts');
console.log('3. Reinicie o servidor WhatsApp na VPS');