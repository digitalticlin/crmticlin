-- CORREÇÃO CIRÚRGICA: Adicionar campos obrigatórios na tabela messages
...
BEGIN
    ...
    -- 💾 INSERIR MENSAGEM COM TODOS OS CAMPOS OBRIGATÓRIOS
    INSERT INTO public.messages (
        ...
        whatsapp_number_id,
        source_edge,
        topic,              -- ✅ CAMPO OBRIGATÓRIO
        extension,          -- ✅ CAMPO OBRIGATÓRIO
        updated_at,         -- ✅ CAMPO OBRIGATÓRIO
        inserted_at         -- ✅ CAMPO OBRIGATÓRIO
    ) VALUES (
        v_message_text,
        p_from_me,
        v_user_id,
        ...
        v_instance_id,
        p_source_edge,
        'whatsapp',         -- ✅ VALOR PADRÃO PARA TOPIC
        'webhook',          -- ✅ VALOR PADRÃO PARA EXTENSION
        NOW(),              -- ✅ VALOR PARA UPDATED_AT
        NOW()               -- ✅ VALOR PARA INSERTED_AT
    )
