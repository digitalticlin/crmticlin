-- CORREÇÃO CIRÚRGICA: Remover conflito de overload da RPC AI
-- Problema: Existem 2 versões da save_sent_message_from_ai

-- 1. REMOVER a versão antiga (que usa p_vps_instance_id uuid)
...
-- 2. MANTER/RECRIAR apenas a versão correta (que usa p_vps_instance_id text)
...
BEGIN
    ...
    -- 📞 FORMATAR NOME DO LEAD (4 dígitos após hífen)
    ...
    -- 🎯 TEXTO DA MENSAGEM (nunca "📎 Mídia" para text)
    ...
    -- 💾 INSERIR MENSAGEM COM CAMPOS OBRIGATÓRIOS
