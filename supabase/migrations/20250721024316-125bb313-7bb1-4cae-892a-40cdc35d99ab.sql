...
-- CORRIGIR A FUNÇÃO REMOVENDO O SET LOCAL ROLE PROBLEMÁTICO
-- A função SECURITY DEFINER já executa com privilégios elevados automaticamente
...
BEGIN
  ...
  -- A função SECURITY DEFINER já executa com privilégios do service_role
  
  -- Log de início
  RAISE NOTICE '[SERVICE_ROLE] 🚀 Iniciando com SECURITY DEFINER para: %', p_vps_instance_id;

  -- ETAPA 1: Buscar instância e user_id (com privilégios elevados)
