...
-- CRIAR NOVA FUNÇÃO SQL OTIMIZADA PARA SERVICE ROLE
-- Esta função não depende de auth.uid() e usa SERVICE ROLE direto
...
DECLARE
  ...
  v_contact_name TEXT;
BEGIN
  -- CONFIGURAR ROLE COMO SERVICE_ROLE PARA BYPASS TOTAL DO RLS
  SET LOCAL role = 'service_role';
  
  -- Log de início
  RAISE NOTICE '[SERVICE_ROLE] 🚀 Iniciando com SERVICE ROLE DIRETO para: %', p_vps_instance_id;

  -- ETAPA 1: Buscar instância e user_id (SEM RLS)
