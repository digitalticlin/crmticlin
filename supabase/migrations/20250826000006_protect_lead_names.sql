-- 🔒 PROTEÇÃO TOTAL DE NOMES DE LEADS
-- Uma vez definido, o nome nunca mais é alterado automaticamente
...
BEGIN
  ...
  ELSE
    -- 🔒 ATUALIZAR LEAD EXISTENTE - NOME PROTEGIDO PARA SEMPRE
    UPDATE public.leads 
    SET 
  ...
  RETURN jsonb_build_object(
    ...
    'data', jsonb_build_object(
      ...
      'name_protected', NOT v_is_new_lead, -- ✅ INDICADOR SE NOME ESTÁ PROTEGIDO
      'method', 'service_role_name_protected'
    )
  );
