...
-- FUNÇÃO SQL OTIMIZADA PARA WEBHOOK WHATSAPP
-- Combina busca de instância + lead + mensagem em uma única operação
...
BEGIN
  ...
  -- ETAPA 4: Buscar funil padrão do usuário (cache otimizado)
  ...
  -- ETAPA 6: Buscar ou criar lead (operação otimizada)
  ...
  IF v_lead_id IS NULL THEN
    ...
    RAISE NOTICE '[save_whatsapp_message_complete] ✅ Novo lead criado: %', v_lead_id;
  ELSE
    ...
    RAISE NOTICE '[save_whatsapp_message_complete] ✅ Lead atualizado: %', v_lead_id;
  END IF;
