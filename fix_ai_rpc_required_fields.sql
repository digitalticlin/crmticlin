-- CORREÇÃO CIRÚRGICA: RPC AI com campos obrigatórios da tabela messages
-- Aplicar a mesma correção que fizemos no webhook
...
BEGIN
    ...
    -- 📞 FORMATAÇÃO CORRETA DO NOME (igual webhook - 4 dígitos após hífen)
    ...
    -- 🎯 TEXTO DA MENSAGEM (igual webhook)
    ...
    -- 💾 INSERIR MENSAGEM COM CAMPOS CORRETOS (igual webhook)
