...
// 🔗 Aguardar conexão do WhatsApp COM IMPORTAÇÃO AUTOMÁTICA
async function waitForWhatsAppConnection(sessionId, page) {
    console.log(`🔗 [${sessionId}] Aguardando escaneamento do QR Code...`);

    try {
        // Aguardar elemento que indica conexão
        await page.waitForSelector('[data-testid="chat"]', { timeout: 300000 }); // 5 minutos
        ...
        sessions.set(sessionId, {
            ...
            message: 'Timeout - QR Code não foi escaneado'
        });
    }
}
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`✅ Servidor pronto com IMPORTAÇÃO AUTOMÁTICA!`);
}); 